...
<script setup>
import { ref, onMounted, watch, h } from "vue"; // MIT License
...
// function addNewAnimalOption(val, hb) {
//   console.log("addNewAnimalOption: ", val);
//   if (!dropdowns.value[hb].animalOptions.includes(val)) {
//     dropdowns.value[hb].animalOptions.push(val);
//   }
// }

// function addNewAnimalOption(val, hb) {
//   if (!val || dropdowns.value[hb].animalOptions.includes(val)) return;

//   console.log("New value:", val);
//   dropdowns.value[hb].animalOptions.push(val); // Add new option
//   userSelections.value[hb].animal.push(val); // Select new option
//   inputValue = ""; // Clear input value for next entry
// }
